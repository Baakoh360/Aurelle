...
import { Sparkles, Heart, Shield, Calendar, ChevronRight } from 'lucide-react-native';
        ...
        <View style={[styles.content, paddingVertical]}>
          {step === 'name' && (
            <>
              <View style={styles.logoContainer}>
                ...
                <View style={styles.featuresContainer}>
                  ...
                  <View style={styles.featureItem}>
                    ...
                    <Text style={styles.featureText}>AI wellness tips</Text>
                  </View>
                  <View style={styles.featureItem}>
              ...
              <LinearGradient colors={['rgba(255, 255, 255, 0.95)', 'rgba(255, 255, 255, 0.9)']} style={styles.formContainer}>
                <Text style={styles.welcomeText}>Welcome to FloAura!</Text>
          ...
          {step === 'skip-message' && (
            <LinearGradient colors={['rgba(255, 255, 255, 0.95)', 'rgba(255, 255, 255, 0.9)']} style={styles.formContainer}>
              ...
              <GradientButton title="Continue to FloAura" onPress={handleSkipMessageContinue} style={styles.button} />
            </LinearGradient>
          )}
        </View>
      </LinearGradient>
...
const styles = StyleSheet.create({
  ...
  featuresContainer: { alignItems: 'center', gap: spacing.base },
  featureItem: {
    flexDirection: 'row',
    alignItems: 'center',
